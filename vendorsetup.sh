...
# device tree
git clone https://github.com/notganesh/android_device_oneplus_ivan.git -b main device/oplus/ivan

# Vendor
git clone https://github.com/notganesh/vendor_oplus_ivan.git vendor/oplus/ivan

# Hardware
git clone -b lineage-20 https://github.com/notganesh/android_hardware_mediatek.git hardware/mediatek
git clone -b lineage-20 https://github.com/notganesh/android_hardware_mediatek_wlan.git hardware/mediatek/wlan
git clone -b lineage-20 https://github.com/notganesh/android_hardware_oplus.git hardware/oplus
